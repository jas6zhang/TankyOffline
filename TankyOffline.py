...
intro = image.load("Tanky_Offline.png")
        
screen.blit(intro,(128,128,1024,702))
display.flip()
time.wait(3000)
...
while running:
    ...
    picPlayer1 = SpriteSheet("RedTank.png")
    picPlayer2 = SpriteSheet("BlueTank.png")
    listPlayer1.append(picPlayer1.get_image(0,0,64,64).convert_alpha())
    listPlayer2.append(picPlayer2.get_image(0,0,64,64).convert_alpha())
    
    draw.circle(screen,(0,0,255),(p1.X,p1.Y),24)
    screen.blit(listPlayer1[0],(p1.X - 32,p1.Y - 32))
    ...
    if p1.Exists == False or p2.Exists == False:
        if p2.Exists == False:
            pwin = image.load("Player_1_Win.png")
        elif p1.Exists == False:
            pwin = image.load("Player_2_Win.png")
        
        screen.blit(pwin,(0,0,1024,702))
        display.flip()
        time.wait(3000)
